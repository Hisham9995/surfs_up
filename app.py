...
#We will convert the unraveled results into a list using list() and jsonify it.
...
# Statistics Route 
# we will Create a query to select the minimum, average, and maximum temperatures
#WE need  the starting and ending date, add an if-not statement.
#The asterik (*)  to indicate there will be multiple results for the query: min, avg, and max
